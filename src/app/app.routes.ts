...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'register',
        loadComponent: () => import("./register/pages/register-page/register-page.component").then((c) => c.RegisterPageComponent),
        data: {title: 'Regisztráció', subtitle: 'Légy te is a közösségünk tagja, tanulj velünk vagy segíts a társaidnak egy-egy jegyzet formájában! A regisztráció első lépéseként add meg a kötelező adatok. Regisztráció után a profilodat személyre tudod szabni, valamint korlátozások nélkül tudod használni az oldalt.'}
      }
